...
public class FieldHandlerTest {
    ...
    public void testFieldHandlerHandler() throws Exception {
        ByteBuffer codeBuf = ClassFileAnalysisMain.readFile("/Users/wjy/MyProjects/asm-bytecode-project/build/classes/java/main/com/congzhizhi/asmbytecode/book/vmstack/Builder.class");
